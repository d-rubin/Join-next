...
const AddTaskPage = async () => {
  ...
  return (
    <PagePadding className="flex flex-col gap-4 relative h-full">
      ...
      <AddTaskFormMobile contacts={contacts} action={createTask} icon="check" text="Create" className="lg:hidden" />
      <AddTaskFormDesktop contacts={contacts} action={createTask} />
    </PagePadding>
  );
};
